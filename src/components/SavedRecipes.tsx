    ...
    return (
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center py-12">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">No Saved Recipes Yet</h2>
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4 order-2 lg:order-1">
          <h2 className="text-lg font-semibold text-gray-800 lg:hidden mb-4">Your Recipes</h2>
              ...
              <CardHeader className="pb-3 px-4 sm:px-6">
                <div className="flex justify-between items-start gap-3">
                  <div className="flex-1 min-w-0">
                    <CardTitle className="text-base sm:text-lg text-gray-800 mb-2 break-words">
                      {recipe.title}
                    </CardTitle>
        ...
        <div className="order-1 lg:order-2 lg:sticky lg:top-24 lg:self-start">
          {selectedRecipe ? (
            <div>
              <h2 className="text-lg font-semibold text-gray-800 lg:hidden mb-4">Recipe Details</h2>
              <Card className="shadow-xl border-0 bg-white">
                <CardHeader className="pb-4 px-4 sm:px-6">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                    ...
                    <Heart className="w-6 h-6 text-red-500 fill-current flex-shrink-0" />
                  </div>
                </CardHeader>
                ...
                <CardContent className="space-y-6 px-4 sm:px-6">
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 text-sm break-words">{selectedRecipe.cooking_tips}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-800 lg:hidden mb-4">Select a Recipe</h2>
              <Card className="shadow-lg bg-gradient-to-br from-orange-50 to-amber-50">
                <CardContent className="text-center py-8 sm:py-12 px-4">
                  <ChefHat className="w-12 sm:w-16 h-12 sm:h-16 text-orange-400 mx-auto mb-4" />
